...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-raptor.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-raptor)
...
```bash
php artisan vendor:publish --tag="laravel-raptor-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-raptor-views"
```

## Usage

```php
$laravelRaptor = new Callcocam\LaravelRaptor();
echo $laravelRaptor->echoPhrase('Hello, Callcocam!');
```
