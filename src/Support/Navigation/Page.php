...
class Page
{
    ...
    public function registerRoutes(): void
    {
        ...
        $routeGroup->group(function () use ($controller) {
            ...
            Route::post('/{id}/repeater-action/{repeaterName}/{actionName}', [$controller, 'executeRepeaterItemAction'])->name('execute-repeater-item-action');
            ...
            // Route::post('search-field/{fieldName}', [$controller, 'executeSearchField'])->name('search-field');
        });
    }
