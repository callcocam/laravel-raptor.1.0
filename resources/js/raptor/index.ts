...
ComponentRegistry.registerBulk({
    ...
    'editable-table-column': defineAsyncComponent(() => import('@raptor/components/table/EditableColumnRenderer.vue')),
    'editable-display': defineAsyncComponent(() => import('@raptor/components/table/columns/editable/EditableDisplay.vue')),
    ...
    'editable-actions': defineAsyncComponent(() => import('@raptor/components/table/columns/editable/EditableActions.vue')),
